...
while winning:
    ...
    random_index2 = random.randint(0, len(data) - 1)
    ...
    def actual_answer():
        '''Calculate Actual Answer. Returns A or B'''
        if data[random_index1]['follower_count'] > data[random_index2]['follower_count']:
            actual_answer = 'A'
        elif data[random_index1]['follower_count'] < data[random_index2]['follower_count']:
            actual_answer = 'B'
        else:
            actual_answer = 'A and B'
        return actual_answer
    actual_answer = actual_answer()
    print(f"cheat: actual answer is {actual_answer}") #cheating

    user_answer = input("Who has more followers? Type 'A' or 'B': ")

    if user_answer == actual_answer:
        print('Correct!')
        # print(f'{actual_answer} is greater')
        counter += 1
        if actual_answer == 'B':
